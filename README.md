...
The [Raw Data](https://github.com/JayCrlt/BenthFun/blob/main/Data_Online/Raw_data) required to run the analyses are also available in the repository. They are organized into six groups: (1) Diving and experiment logbook, (2) pH datasets, (3) Function datasets, (4) Cover datasets, (5) Biomass datasets, and (6) PAR dataset. A more detailed description of these datasets and how they are loaded is provided in the [02_Load_Data.R script](https://github.com/JayCrlt/BenthFun/blob/main/R_Script/02_Load_Data.R). All datasets are stored in .RData format to allow faster and more efficient loading within R.
